                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Order Management Table</strong>
                                    <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#smallmodal_o2<?php echo $user_session;?>" style="margin-left:77%"><i class="fa fa-plus">Add</i>
                               </button>
...
<?php } ?>
 ...
 <?php include 'modal/clientorder2_modal.php';?>
 <?php include 'modal/clientorderedit2_modal.php';?>
 <?php include 'modal/clientorderdelete2_modal.php';?>
               ...
               function load_data() {
                 ...
                 function getIDa(order_id) {
                      $.ajax({
                          ...
                          $('#edit_customername').val(response.customer_name);
