 ...
 <!--/.col-->
    ...
    <div class="col-6 col-lg-4">
        <div class="card">
            <div class="card-body">
             <?php
                foreach($countservices as $services){ ?>
                <div class="clearfix">
                    <i class="fa fa-users bg-warning p-3 font-2xl mr-3 float-left text-light"></i>
                    <div class="h5 text-secondary mb-0 mt-1"><?= htmlentities(number_format($services['s_fee'])); ?></div>
                    <div class="text-muted text-uppercase font-weight-bold font-xs small">Total Services</div>
                </div>
                 <?php } ?> 
                <div class="b-b-1 pt-3"></div>
                <hr>
